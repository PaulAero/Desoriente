...
##                                        Création du bouton vers l'horizon artificiel
    ...
    def bouton_vario (self):
        ...
        self.bouton_horizon.place(x=(self.root.winfo_screenwidth()//20), y=ordonnee_bouton)
    ...
    def bouton_carte(self):
        ...
        self.button_carte = tk.Button (self.root,text = "To Track",font= f,fg="white",bg="grey",height = height_button, width = width_button,command=lambda:self.ouvrir_carte_gps())
        button_vario_coordinate_y=self.root.winfo_screenheight()/2-(height_button+1)*font_size
        self.button_carte.place(x=self.root.winfo_screenwidth()-((self.root.winfo_screenwidth()//10)+width_button), y=button_vario_coordinate_y)
